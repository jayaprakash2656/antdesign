...
import { StarOutlined, MessageOutlined, CheckOutlined } from '@ant-design/icons';
              ...
              <Row>
                ...
                <Col sm={14} md={16} xl={20} style={{padding: '10px 20px'}}>
                  <div className="user-details">
                    <span className="floating-icon"><StarOutlined /></span>
                    ...
                    <div className="m-t-30 m-b-30 user-buttons">
                      <Button><MessageOutlined />Send Message</Button>
                      <Button><CheckOutlined /> Contacts</Button>
